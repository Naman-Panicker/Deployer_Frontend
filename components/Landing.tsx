...
export default function Landing() {
  ...
  const handleDeploy = () => {
    if (!repoLink || repoLink.trim() === "") {
      setInlineError("Please enter a valid repository URL");
      return;
    }

    // Immediately navigate to the tracking page without blocking
    navigate("/deploy/init", {
      state: { repoUrl: repoLink.trim() }
    });
  };
